...
The above graph shows the data for Adelie penguins in the palmerpenguins package. My null hypothesis is that flipper length in these penguins is not predicted by body mass, and so the linear regression model is not statistically significant. My alternative hypothesis is that body mass does predict flipper length in this species, and so the regression model is signficant.
